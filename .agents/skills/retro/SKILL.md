...
1. Read and apply [writing-for-agents](../writing-for-agents/SKILL.md) for the writing style guide.
...
The review agent starts from the diff and reads the surrounding code and standards needed to assess it. It often does not need to write code or debug.

The implementation agent applies the existing standards while building; the review agent independently checks compliance. Security and privacy requirements belong to implementation as well as review.
...
- `CODING_STANDARDS.md`, when present: read the applicable standards during implementation and review. Add **navigation pointers** to docs folders if the standards file gets more than 1,000 lines long.
