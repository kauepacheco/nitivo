...
Read `docs/agents/issue-tracker.md` for the issue tracker workflow. If it is
missing, use the originating spec supplied by the user or available in the repo
and report that the tracker configuration is missing.
