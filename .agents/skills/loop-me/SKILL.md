...
In Nitivo, keep personal NOTES.md and workflow sketches in a dedicated workspace (default: `.local/workflows/`). Move only explicitly requested product deliverables into versioned product documentation.
