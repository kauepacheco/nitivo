...
Os quatro primeiros incrementos do piloto já entregam acesso assistido do
...
contato operacional da lavação.
...
os quatro primeiros estão concluídos e os seguintes aguardam novas solicitações.
